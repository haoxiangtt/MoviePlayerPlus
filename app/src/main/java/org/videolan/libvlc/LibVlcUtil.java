...
public class LibVlcUtil {
	...
	public static boolean isFroyoOrLater() {
		return android.os.Build.VERSION.SDK_INT >= 8;//android.os.Build.VERSION_CODES.FROYO;
	}

	public static boolean isGingerbreadOrLater() {
		return android.os.Build.VERSION.SDK_INT >= 9;//android.os.Build.VERSION_CODES.GINGERBREAD;
	}

	public static boolean isHoneycombOrLater() {
		return android.os.Build.VERSION.SDK_INT >= 11;//android.os.Build.VERSION_CODES.HONEYCOMB;
	}

	public static boolean isICSOrLater() {
		return android.os.Build.VERSION.SDK_INT >= 15;//android.os.Build.VERSION_CODES.ICE_CREAM_SANDWICH;
	}
	...
	public static boolean isJellyBeanMR1OrLater() {
		return android.os.Build.VERSION.SDK_INT >= 17;//android.os.Build.VERSION_CODES.JELLY_BEAN_MR1;
	}

	public static boolean isJellyBeanMR2OrLater() {
		return android.os.Build.VERSION.SDK_INT >= 18;//android.os.Build.VERSION_CODES.JELLY_BEAN_MR2;
	}

	public static boolean isKitKatOrLater() {
		return android.os.Build.VERSION.SDK_INT >= 19;//android.os.Build.VERSION_CODES.KITKAT;
	}

	public static boolean isLolliPopOrLater() {
		return android.os.Build.VERSION.SDK_INT >= 20;//android.os.Build.VERSION_CODES.LOLLIPOP;
	}
	...
	private static String[] CPU_archs = { "*Pre-v4", "*v4", "*v4T", "v5T", "v5TE", "v5TEJ", "v6", "v6KZ", "v6T2", "v6K", "v7", "*v6-M", "*v6S-M", "*v7E-M",
			"*v8" };
	...
	private static boolean readHeader(RandomAccessFile in, ElfData elf) throws IOException {
		...
		in.readFully(bytes);
		if (bytes[0] != 127 || bytes[1] != 'E' || bytes[2] != 'L' || bytes[3] != 'F' || bytes[4] != 1) { // ELFCLASS32, Only 32bit header is supported
			return false;
		}
