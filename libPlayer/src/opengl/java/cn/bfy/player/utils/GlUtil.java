...
public class GlUtil {
    ...
    public static int createProgram(String vertexSource, String fragmentSource) {
        ...
        if (program == 0) {
            Log.e("gl", "Could not create program");
        }
        ...
        if (linkStatus[0] != GLES20.GL_TRUE) {
            ...
            Log.e("gl", GLES20.glGetProgramInfoLog(program));
    ...
    public static int loadShader(int shaderType, String source) {
        ...
        if (compiled[0] == 0) {
            Log.e("gl", "Could not compile shader " + shaderType + ":");
    ...
    public static void logVersionInfo() {
        Log.e("gl", "vendor  : " + GLES20.glGetString(GLES20.GL_VENDOR));
        Log.e("gl", "renderer: " + GLES20.glGetString(GLES20.GL_RENDERER));
        Log.e("gl", "version : " + GLES20.glGetString(GLES20.GL_VERSION));
